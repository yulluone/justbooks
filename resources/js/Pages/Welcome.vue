...
<template>
    ...
    <div
        class="flex justify-center items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white"
    >
        ...
        >
            <div class="flex justify-center group">
                <svg
                    ...
                    stroke-width="0.5"
                    stroke="currentColor"
                    class="w-28 h-28 stroke-gray-600"
                >
                    <path
